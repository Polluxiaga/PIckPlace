...
CONFIG_NAME="pi0_fast_rlbench_pickplace_rand1_lora_cam_qbin64_all"
...
"${ROOT_DIR}/.venv/bin/python" "${ROOT_DIR}/scripts/train.py" \
  "${CONFIG_NAME}" \
  "$@"
